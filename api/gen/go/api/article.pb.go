...
var file_api_article_proto_rawDesc = []byte{
	...
	0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x02, 0x69, 0x64, 0x32, 0xfd, 0x04, 0x0a, 0x0e, 0x41,
	...
	0x72, 0x42, 0x79, 0x4b, 0x65, 0x79, 0x3a, 0x01, 0x2a, 0x12, 0x3a, 0x0a, 0x09, 0x44, 0x65, 0x6c,
...
var file_api_article_proto_depIdxs = []int32{
	...
	6,  // 4: api.ArticleService.DelAuthor:input_type -> api.AuthorID
	1,  // 5: api.ArticleService.PutArticle:input_type -> api.Article
	2,  // 6: api.ArticleService.GetArticle:input_type -> api.ArticleID
	2,  // 7: api.ArticleService.DelArticle:input_type -> api.ArticleID
	1,  // 8: api.ArticleService.UpdateArticle:input_type -> api.Article
	3,  // 9: api.ArticleService.ListArticle:input_type -> api.ListArticleReq
	0,  // 10: api.ArticleService.Ping:output_type -> api.Empty
	6,  // 11: api.ArticleService.AddOrUpdateAuthor:output_type -> api.AuthorID
	0,  // 12: api.ArticleService.DelAuthorByKey:output_type -> api.Empty
	0,  // 13: api.ArticleService.DelAuthor:output_type -> api.Empty
	2,  // 14: api.ArticleService.PutArticle:output_type -> api.ArticleID
	1,  // 15: api.ArticleService.GetArticle:output_type -> api.Article
	0,  // 16: api.ArticleService.DelArticle:output_type -> api.Empty
	0,  // 17: api.ArticleService.UpdateArticle:output_type -> api.Empty
	4,  // 18: api.ArticleService.ListArticle:output_type -> api.ListArticleRes
