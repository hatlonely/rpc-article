...
var file_api_article_proto_rawDesc = []byte{
	...
	0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x02, 0x69, 0x64, 0x32, 0xa4, 0x03, 0x0a, 0x0e, 0x41,
	...
	0xd3, 0xe4, 0x93, 0x02, 0x07, 0x12, 0x05, 0x2f, 0x70, 0x69, 0x6e, 0x67, 0x12, 0x42, 0x0a, 0x0a,
...
var file_api_article_proto_depIdxs = []int32{
	...
	1, // 2: api.ArticleService.PutArticle:input_type -> api.Article
	2, // 3: api.ArticleService.GetArticle:input_type -> api.ArticleID
	2, // 4: api.ArticleService.DelArticle:input_type -> api.ArticleID
	1, // 5: api.ArticleService.UpdateArticle:input_type -> api.Article
	3, // 6: api.ArticleService.ListArticle:input_type -> api.ListArticleReq
	0, // 7: api.ArticleService.Ping:output_type -> api.Empty
	2, // 8: api.ArticleService.PutArticle:output_type -> api.ArticleID
	1, // 9: api.ArticleService.GetArticle:output_type -> api.Article
	0, // 10: api.ArticleService.DelArticle:output_type -> api.Empty
	0, // 11: api.ArticleService.UpdateArticle:output_type -> api.Empty
	4, // 12: api.ArticleService.ListArticle:output_type -> api.ListArticleRes
